              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php foreach ($pending_user as $item): ?>
				 ...
				 <td><?php if($item['slip']!="") { ?><a href="../../user/uploads/<?php echo $item['slip'] ?>" target="_blank"><img src="../../user/uploads/<?php echo $item['slip'] ?>" width="50" height="50" alt=""/></a><?php }?></td>
                  <td><a class="btn btn-success" href="<?= base_url()?>Admin_dashboard/activate_user_view?id=<?=$item['id'] ?>">Activate</a></td>
                  <td><a class="btn btn-warning" href="<?= base_url()?>Admin_dashboard/delete_user_action?id=<?=$item['id'] ?>">Delete</a></td>
                 <!-- <td></td> -->
