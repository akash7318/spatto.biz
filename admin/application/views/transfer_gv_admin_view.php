           ...
           <?= form_open('admin_dashboard/allocate_gv_admin', array( 'class' => 'form-horizontal')); ?>  
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Gift Voucher Code</label>

                  <div class="col-sm-10">
                    <input class="form-control" id="amount" placeholder="Code for Gift Voucher" type="text" name="code">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="amount" placeholder="Amount of Voucher" type="number" name="amount">
                  </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="remarks" placeholder="Enter Validity" type="text" name="validity">
                  </div>
                </div>
...
<script>
	...
	//alert(value);	
			$.ajax({
	        url: "http://venjio.com/user/getsp_id.php",
	        type: "GET",
	        data: "name=" + value,
