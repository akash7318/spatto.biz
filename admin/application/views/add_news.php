      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-info">
            ...
            <!-- form start -->
           <?= form_open('admin_dashboard/submit_news', array( 'class' => 'form-horizontal')); ?>  
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Title</label>

                  <div class="col-sm-10">
                    <input class="form-control" id="inputEmail3" placeholder="Enter News Title" type="text" name="title">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
					  <textarea class="form-control" id="inputEmail3" name="detail"></textarea>
                  </div>
                </div>  
