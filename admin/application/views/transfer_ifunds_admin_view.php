...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Send Funds to iWallet
        <small>Dashboard</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> iWallet Funds</a></li>
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-info">
            <!-- form start -->
           <?= form_open('admin_dashboard/allocate_ifunds_admin', array( 'class' => 'form-horizontal')); ?>  
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="remarks" value="iWallet Fund Transfer from Admin" type="text" name="remarks">
                  </div>
                </div>
