      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-info">
            <!-- form start -->
           <?= form_open('admin_dashboard/withdrawfunds_submit', array( 'class' => 'form-horizontal')); ?>
           <input type="hidden" name="mid" value="<?=$mid?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Amount in Wallet</label>

                  <div class="col-sm-10">
                    <input class="form-control" id="amount" placeholder="Amount in Wallet" type="number" name="amount" min="1" max="<?=$wallet?>" step="0.01" value="<?=$wallet?>">
                  </div>
                </div>
                 <div class="form-group">
