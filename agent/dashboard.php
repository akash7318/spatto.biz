...
?>
  ...
  <div class="content-wrapper">
	...
	<p>Your refer link is :  <a href="http://spatto.biz/agent/signup.php?ref=<?=$username?>">http://spatto.biz/agent/signup.php?ref=<?=$username?></a>&nbsp;&nbsp;&nbsp;  
                                                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://spatto.biz/agent/signup.php?ref=<?=$username?>" style="color: #3b5998" target="_blank"><i class="fa fa-facebook-square fa-2x"></i></a> &nbsp;

                                <a href="https://twitter.com/intent/tweet?source=http://spatto.biz/agent/signup.php?ref=<?=$username?>" style="color: #00acee" target="_blank"><i class="fa fa-twitter-square fa-2x"></i></a>&nbsp;

                                <a href="whatsapp://send?text=click on the link to register : http://spatto.biz/agent/signup.php?ref=<?=$username?>" data-action="share/whatsapp/share" style="color: green"><i class="fa fa-whatsapp fa-2x"></i></a>
                            </p>
