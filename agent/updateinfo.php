    ...
    <div class=" col-sm-5" style="background: #fff">
        ...
        <div class="box-body">
              				...
              				<p><br><br><br></p>
              						...
              						<div class="form-group">
              							<label>City</label>
			  							<input name="city" type="text" value="<?=$city?>" id="city" class="form-control" placeholder="City"/>
              						</div>
              						
              						<div class="form-group">
              							<label>State</label>
			  							<input name="state" type="text" value="<?=$state?>" id="state" class="form-control" placeholder="State" />
              						</div>
              						...
              						<div class="form-group">
              							<label>Pincode</label>
			  							<input name="pincode" type="text" value="<?=$pincode?>" id="pincode" class="form-control" placeholder="Pincode"/>
              						</div>
