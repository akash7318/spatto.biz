                ...
                <div class="container clearfix" style="background: #fff;">
                    ...
                    <div class="header-inner d-lg-flex align-items-center">
                        ...
                        <div class="menu-number">
                            <!--<i class="flaticon-headphone"></i> <a href="callto:+918892666688">+91 8892 6666 88</a>-->
                        </div>
                    </div>
                            ...
                            <div class="sidebar-widget bg-snow">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="right-content">
                                            <a href="callto:+91013535322429">+91 013535322429</a><br>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="left-icon">
                                        ...
                                        <div class="right-content">
                                            <a href="mailto:info@spatto.biz">info@spatto.biz</a><br>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
-->
                    ...
                    <div class="col-lg-8">
                        ...
                        <p>Spatto से सम्बंधित, किसी भी तरह के समाधान के लिये, हमारे कस्टमर केयर नम्बर पर कॉल करें।</p>
                        <form id="call-back-form" class="call-back-form" name="call-back-form" action="#" method="post">
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="theme-btn" type="submit" style="min-width: 150px;padding: 10px;">Submit Now </button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="cta-btn wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                            <a href="user/rules.php" style="min-width: 150px;padding: 7px 47px 7px 45px; min-width: 150px; margin-top: 10px;" class="theme-btn">संपर्क करें </a>
                        </div>
                    </div>
                </div>
            </div>
