...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        My Network
        <small>Direct Users</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Direct Users</li>
      </ol>
    </section>
	...
	<div class=" col-sm-12" style="background: #fff">
        <div class="box-header with-border">
          <h3 class="box-title">Direct Users</h3>
      ...
      <tr>
        ...
        <th style="text-align: center;">Assigned Area</th>
      ...
      <?php 
                                  ...
                                  $sql  = "SELECT id,name,username,email,phone,sponsor,DATE_FORMAT(jdate, '%d-%m-%Y'),dreferal,area FROM `join_agent` WHERE `sponsor` = '$username' ";
                                  $result = mysqli_query($s_dbid,$sql);
      
                                  while(list($mid,$name,$luser,$email,$phone,$sponsor,$jdate,$direct,$area) = @mysqli_fetch_row($result)){
