...
$message = rawurlencode("Dear ".$username." a withdrawal request is placed for amount - ".$amount.". Your one time password is ".$vcode.". Spatto Travels www.spattoservices.com");
