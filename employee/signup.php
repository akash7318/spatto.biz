...
<head>
  ...
  <title>Spatto Employee | Registration Page</title>
...
<div style="margin-left: 10px; margin-right: 10px; margin-top: 20px;">
  <div class="register-logo">
    <a href="#"><b><img src="https://spatto.co/assets/images/spatto-logo.png" style="width: 200px;margin-left: auto;margin-right: auto; margin-top:0px;"></b><br>Employee</a>
  </div>

  <div class="register-box-body" style="background:rgba(255, 255, 255, 0.74)">
<!--    <p class="login-box-msg">-->
	  <h3 align="center">Register as an Employee</h3>
<!--	  </p>-->
...
<div class="col-sm-6  pass-log-trans">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="text-left">Supervisor<span class="mendatory">*</span></label>
                                                ...
                                                <div class="col-sm-2" style="padding-top: 20px;">
                                                    <button type="submit" class="btn btn-primary btn-block btn-sm offset-top-22">Employee Registration</button>
