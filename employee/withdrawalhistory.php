...
?>
  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
      ...
      <?php
        $cnt=1;
        $sql = "select `join`.name,`join`.username,`amount`,`Status`,`wdate`,wtype,remark from `join`,withdraw where `join`.id = '$mid' and `join`.id=`withdraw`.jid and `wtype` NOT LIKE 'iWallet%';";
