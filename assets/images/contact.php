...
<head>
    ...
    <title>Contact Us || Spatto Services</title>
        ...
        <header class="main-header">
            ...
            <div class="header-top bg-orange">
                <div class="container">
                    <div class="top-inner">
                        <ul class="top-left">
                            <li><i class="fa fa-envelope"></i> <a href="mailto:info@spattoservices.com">info@spattoservices.com</a></li>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="#">Business Plan</a>
                                            <ul>
                            ...
                            <div class="sidebar-widget bg-snow">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="right-content">
                                            <a href="callto:+919876543210">+919876543210</a><br>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="left-icon">
                                        ...
                                        <div class="right-content">
                                            <a href="mailto:info@spattoservices.com">info@spattoservices.com</a><br>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
-->
                    ...
                    <div class="col-lg-8">
                        ...
                        <p>Spatto से सम्बंधित किसी भी प्रश्न या सहायता के लिए कृपया हमसे बेझिझक संपर्क करें और हम जल्द से जल्द आपसे संपर्क करेंगे</p>
...
-->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="cta-text wow fadeInUp rmb-25" data-wow-duration="2s">
                            <h3>क्या आप सर्वश्रेष्ठ उपभोक्ता सेवा कंपनी <br>के साथ काम करना चाहते हैं?</h3>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cta-btn wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                            <a href="contact.html" class="theme-btn">हमसे यहां संपर्क करें <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        =====================================================================-->
        <footer class="footer-section bg-blackrpt-100">
               ...
               <div class="container">
                    <div class="copyright-inner align-items-center">
                        <div class="copyright-wrap order-2 order-md-1">
                            <p>Copyright © Spatto <span>2021</span> | All Rights Reserved.</p>
                            <!-- Scroll Top Button -->
