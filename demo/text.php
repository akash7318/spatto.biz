...
function send_registration_message($user_name,$number,$userid,$password)
    {
      ...
      $message = "Dear ".$user_name." You have Successfully Registered. Your User ID is ".$userid." Password is ".$password." Thank You for joining with us. Spatto Travel www.spatto.biz";
...
function send_activation_message($user_name,$number,$userid,$password)
    {
      ...
      $message = "Dear ".$user_name." Your account has been successfully activated.Your User ID is ".$userid." Password is ".$password.". Spatto Travel www.spatto.biz";
