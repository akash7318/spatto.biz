  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
      ...
      <tbody>
		      <?php
		        $cnt=1;
		        $sql = "select `join`.name,`join`.username,`comm`,`rname`,`remarks`,`ttime`,`rname` FROM `join_store`,inv_transactions where `join`.id = '$mid' and `join`.id = `inv_transactions`.mid and remarks like '%Direct%';";
