...
<!--<br>-->
  ...
  <tr>
	...
	<th align='center' scope="col">Customer Name</th>
	<th align='center' scope="col">Customer A/C Code</th>
	<th align='center' scope="col">Order Date</th>
    <th align='center' scope="col"></th>
	<th align='center' scope="col"></th>
  </tr>
  </thead>
  ...
  $sno =0;
  $sql  = "SELECT `id`, `mid`, `sid`, `order_date`,`status` FROM `orders` WHERE sid = '$sid' and status = 'Pending'";
...
<tr>
    ...
    <td align='left'>
        <form method="post" action="update_cancel_order.php">
          <input type="hidden" name="oid" value="<?=$oid?>">
