  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
        <div class="box-header with-border">
          <h3 class="box-title">Daily Sale Report</h3>
...
<!--<br>-->
  ...
  <tr>
	...
	<th align='left' scope="col">Billing Amt</th>
	<th align='left' scope="col">Order Date</th>
	<th align='left' scope="col">Spatto Commission</th>
  </tr>
  </thead>
  <tbody>
	<?php 
  ...
  $sno =1;
  $sql  = "SELECT DATE_FORMAT(order_date, '%d-%m-%Y') as order_date,sum(total) as total FROM `orders` WHERE sid = '$mid' and STATUS like 'Closed' GROUP by order_date";
  
  $result = mysqli_query($s_dbid,$sql);
  $cnt=1;

  while(list($order_date,$total) = @mysqli_fetch_row($result)){
