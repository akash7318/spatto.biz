...
$pansql = "select id FROM `bank_store` WHERE `idnumber` = '$idnumber' ;"; 
...
$detailsql = "select id FROM `join_store` WHERE `username` = '$username' ;"; 
...
$sql = "select * FROM `bank_store` where jid='$mid'";
