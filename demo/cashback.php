	...
	<div  style="background: #fff">
      ...
      <tbody>
		      <?php
		        ...
		        $sql = "select `join`.name,`join`.username,`comm`,`level`,`remarks`,`ttime`,`rname` FROM `join_store`,inv_transactions where `join`.id = '$mid' and `join`.id = mid and remarks like '%Cashback Income%';";
