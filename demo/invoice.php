...
$sql  = "SELECT id,DATE_FORMAT(jdate, '%d-%m-%Y') FROM `join_store` WHERE `username` = '$username' order by id";
$result = mysqli_query($s_dbid,$sql);
  ...
  <div class="main-container p-invoice">
    <div class="p-invoice__header">
      <div class="p-invoice__company">
        <img src="http://spatto.biz/images/logo-white.png" alt="" class="p-invoice__company-avatar">
