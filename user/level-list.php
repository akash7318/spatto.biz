	...
	<div  style="background: #fff">
      ...
      <tr>
        ...
        <td width="24%" align="center">
      	...
      	$active1=$active2=$active3=$active4=$active5=$active6=$active7=$active8=$active9=$active10=$active11=$active12=$active13=$active14=$active15=$active16=0;
      	  		...
      	  		$boardsql  = "SELECT username,misc FROM `join_store` WHERE `sponsor` = '$username' ";
      ...
      <tr>
        ...
        <td align="center">
      	<?php
      	  $secondlvl=0;
      	  $boardsql  = "SELECT username  FROM `join_store` WHERE `sponsor` = '$username' ";
      		$bresult = @mysqli_query($s_dbid,$boardsql);
      	    //echo $boardsql;
      		while(list($susers) = mysqli_fetch_row($bresult)){
      			$sql2  = "SELECT username,misc  FROM `join_store` WHERE `sponsor` = '$susers' ";
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$suserstxt = substr($suserstxt,0,-1);
      	 $thirdlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$suserstxt.")";
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$tuserstxt = substr($tuserstxt,0,-1);
      	 $fourthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$tuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$fuserstxt = substr($fuserstxt,0,-1);
      	 $fifthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$fuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
        ...
        <td align="center">
      	...
      	$fiuserstxt = substr($fiuserstxt,0,-1);
      	 $sixthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$fiuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$sixuserstxt = substr($sixuserstxt,0,-1);
      	 $seventhlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$sixuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$seuserstxt = substr($seuserstxt,0,-1);
      	 $eigthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$seuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$euserstxt = substr($euserstxt,0,-1);
      	 $ninthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$euserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$nuserstxt = substr($nuserstxt,0,-1);
      	 $tenthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$nuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
        ...
        <td align="center">
      	...
      	$teuserstxt = substr($teuserstxt,0,-1);
      	 $eleventhlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$teuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$eluserstxt = substr($eluserstxt,0,-1);
      	 $twelthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$eluserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$twuserstxt = substr($twuserstxt,0,-1);
      	 $thirteenlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$twuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$thiruserstxt = substr($thiruserstxt,0,-1);
      	 $fourteenlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$thiruserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
      ...
      <tr>
        ...
        <td align="center">
      	...
      	$fourteenuserstxt = substr($fourteenuserstxt,0,-1);
      	 $fifteenthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$fourteenuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
        ...
        <td align="center">
      	...
      	$fifteenuserstxt = substr($fifteenuserstxt,0,-1);
      	 $sixteenthlvl = 0; 
      	$sql3 = "SELECT `username`,misc FROM `join_store` WHERE `sponsor` IN (".$fifteenuserstxt.")";
      	$result3 = mysqli_query($s_dbid,$sql3);
      	  while(list($tusers,$ustatus) = mysqli_fetch_row($result3)){
