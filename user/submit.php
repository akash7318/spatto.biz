...
//echo $flag."test";
		...
		$msg="";
			...
			$sql = "INSERT INTO `join_store` VALUES (NULL, '$name', '$phone', '$email', '$sponsor', '$username', '$password', NULL, '$direct',  NULL, 'pending', '$jdate', '$tpassword',  '$title', '$country', '$state', '$city', '$address','$pincode','$landmark','$store_name','$category');";
			$result = mysqli_query($s_dbid,$sql);
