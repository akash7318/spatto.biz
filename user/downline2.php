...
<br>
  ...
  <tr>
	...
	<th align='center' scope="col">User Id</th>
    <th align='center' scope="col">Name</th>
    <th align='center' scope="col">Income</th>
    <th align='center' scope="col">TDS</th>
    <th align='center' scope="col">Admin Charge</th>
    <th align='center' scope="col">Dispatched Amt</th>
    <th align='center' scope="col">Income Type</th>
  ...
  <tbody>
		      <?php
		        ...
		        $ttds = 0;
		        if($date1==$date2){
		            $sql = "select `join`.name,`join`.username,`comm`,`level`,`remarks`,`ttime`,`rname`,`status` FROM `join_store`,inv_transactions where `join`.id = '$mid' and `join`.id = mid and (`remarks` NOT LIKE 'iWallet Fund Transfer from Admin%' and remarks NOT IN ('iWallet Funds','iWallet Transfer','Wallet Transfer'))  order by inv_transactions.ttime";
		        }
		        else{
