...
<?php
          $oid = $_POST['oid'];
            ...
            $sql2 ="SELECT `store_name`,`name`, `state`, `city`, `address`, `pincode`, `landmark`,`username`,`phone` FROM `join_store` WHERE id = '$sid'";
              $result2 = mysqli_query($s_dbid,$sql2);    
              list($store_name,$name,$state,$city,$address,$pincode,$landmark,$store_username,$stor_phone)  = @mysqli_fetch_row($result2);
            
            $sql2 ="SELECT `name`, `username`,`phone` FROM `join` WHERE  id = '$mid'";
            $result2 = mysqli_query($s_dbid,$sql2);    
            list($customer_name,$customer_user,$customer_phone)  = @mysqli_fetch_row($result2);
            $total = 0;
          ?>
  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
		...
		<div id="GFG" >	    	
              ...
              <table width="100%" cellpadding="4" cellspacing="4" style="border: none; margin-bottom: 20px; font-size: 18px; height: 100px;" cell-padding="4">
                <tr style=" line-height: 30px;">      
                <td align="center"><strong>Code :  <?=$store_username?></strong></td>
                <td align="center"><strong>Phone No. : <?=$store_phone?></strong></td>
                <td align="center"><strong>Bill No. : <?=$id?></strong></td>  
                </tr>
                <tr style=" line-height: 30px;">      
                <td colspan="3" align="center"><font style="font-size:24px;"><strong><?=$store_name?></strong></font></td>
                </tr>
      		</table>
              
              <table width="100%" cellpadding="4" cellspacing="4" style="border: none; margin-bottom: 10px; font-size: 18px;" cell-padding="4">
                    <tr style=" line-height: 30px;">      
                    <td align="center"><strong><?=date("d-m-Y",strtotime($order_date))?></strong></td>
                    
                    </tr>
          	  </table>
              
              <table width="100%" cellpadding="4" cellspacing="4" style="border: none; margin-bottom: 20px; font-size: 18px;" cell-padding="4">
              <tr style=" line-height: 30px;">      
      			<td align="center"><strong>Code :  <?=$customer_user?></strong></td>
      			<td align="center"><strong>Customer : <?=$customer_name?></strong></td>
				<td align="center"><strong>Phone : <?=$customer_phone?></strong></td>  
      		</tr>
      		</table>
  		...
  		<!--</div>-->
            <!--<div class="form-group"><br></div>-->
             ...
             <tr style="line-height: 45px; border-top: 1px solid #ccc;">
              ...
              <img src="print-footer.png" class="invisible" style="width: 100%;">
