...
?>
  ...
  <div class="content-wrapper">
	...
	<p>Your refer link is :  <a href="https://spatto.biz/user/signup.php?ref=<?=$username?>">https://spatto.biz/user/signup.php?ref=<?=$username?></a>&nbsp;&nbsp;&nbsp;  
                                                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://spatto.biz/user/signup.php?ref=<?=$username?>" style="color: #3b5998" target="_blank"><i class="fa fa-facebook-square fa-2x"></i></a> &nbsp;

                                <a href="https://twitter.com/intent/tweet?source=http://spatto.biz/user/signup.php?ref=<?=$username?>" style="color: #00acee" target="_blank"><i class="fa fa-twitter-square fa-2x"></i></a>&nbsp;

                                <a href="whatsapp://send?text=click on the link to register : http://spatto.biz/user/signup.php?ref=<?=$username?>" data-action="share/whatsapp/share" style="color: green"><i class="fa fa-whatsapp fa-2x"></i></a>
                            </p>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?=$my_users?><sup style="font-size: 20px">Rs</sup></h3>

              <p>Withdrawal Current Month</p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-12 connectedSortable" style="min-height: 0px;">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Sale Detail</li>
            </ul>
...
-->
      ...
      <?php
        $cnt=1;
        $sql = "select `join`.name,`join`.username,`amount`,`Status`,`wdate`,wtype,remark FROM `join_store`,withdraw where `join`.id = '$mid' and `join`.id=`withdraw`.jid and `wtype` NOT LIKE 'iWallet%' order by wdate desc limit 5";
      ...
      <tbody>
		      <?php
		        ...
		        $ttds = 0;
		            ...
		            $sql = "select `join`.name,`join`.username,`comm`,`level`,`remarks`,`ttime`,`rname`,`status` FROM `join_store`,inv_transactions where `join`.id = '$mid' and `join`.id = mid and (`remarks` NOT LIKE 'iWallet Fund Transfer from Admin%' and remarks NOT IN ('iWallet Funds','iWallet Transfer','Wallet Transfer'))  order by inv_transactions.ttime desc limit 5";
		        ...
		        $tamt += $amt;	
		        $sql1 = "select name FROM `join_store` where username = '$rname'";
...
-->
          ...
          <div class="row">
              <br><br>
  	<div class="col-lg-4">
  		<div class="nav-tabs-custom" style="cursor: move; height: 340px;">
			
			<ul class="nav nav-tabs pull-right">
              <li class="pull-left header" style="font-weight: bold;"><i class="fa fa-inbox"></i> Spatto Store Details</li>
            </ul>
...
$name = @$_SESSION['name'];
      ?>
  		     <tr> <td>Customer Code</td> <td><span id="ctl00_ContentPlaceHolder1_lbluserid"><?=$username?></span></td>   </tr>
  		   ...
  		   <tr> <td>Code Issue : </td> <td><span id="ctl00_ContentPlaceHolder1_lbljoindate"><?=$jdate?></span></td>   </tr>
    ...
    <div class="col-lg-4">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs pull-right">
                            <li class="pull-left header" style="font-weight: bold;"><i class="fa fa-inbox"></i> Spatto Bank Details </li>
                        </ul>
                        <table class="table" style="font-size: 16px; text-align:left;">
                        <tbody>
                        <tr> <td style="font-weight: bold;"> ICICI Bank </td> <td><span id="ctl00_ContentPlaceHolder1_lbluserid" style="font-weight: bold;">Account - 016405008825 <br>
                        IFSC Code - ICIC0000164 <br>
                        Branch - Hathibarkala <br>
                        Branch Code - 0164</span>
                         <br><br>
                        <img src="Spatto-ICICI.png" style="width: 150px;border: 1px solid;">
                        <br><br>
                        </td>   </tr>
                        </tbody>
                        </table>
                ...
                <div class="col-lg-4">
                    <div class="nav-tabs-custom">
                        ...
                        <table class="table" style="font-size: 16px; text-align:left;">
                        <tbody>
                        <tr> <td style="font-weight: bold;"> HDFC Bank </td> <td><span id="ctl00_ContentPlaceHolder1_lbluserid" style="font-weight: bold;">Account - 50200064061230 <br>
    IFSC Code - HDFC0000225 <br>
    Branch - Rajpur Road <br>
    Branch Code - 0225</span>
                    <br><br>
                        <img src="Spatto-HDFC.jpeg" style="width: 150px;border: 1px solid;">
                    <br><br>    
    </td>   </tr>
                        </tbody>
                        </table>
