...
<?php
$sql = "select `name`,`email`,`mobile` FROM `join_store` where `username` = '$s_username';";           
  ...
  <div class="content-wrapper">
	...
	<div  style="background: #fff">
		...
		<?php
			  ...
			  ?>
			  <?php
			      $sql = "SELECT  `panimage`, `afront`, `aback`, `panstatus`, `idstatus` FROM `bank_store` WHERE `jid` = '$mid'";
			      $result = @mysqli_query($s_dbid,$sql);
