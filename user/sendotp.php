...
$sql = "select `id`,`phone`,`email`,`name` FROM `join_store` where `username` = '$username';";
...
$message = rawurlencode("Dear ".$username." a withdrawal request is placed for amount - ".$amount.". Your one time password is ".$vcode.". Spatto Travels www.spatto.biz");
...
@$result = array('status' => "true" ,'message'=>"Mobile OTP Sent" ,'output'=>$output );
