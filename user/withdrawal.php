...
<?php
$sql = "select `account_no`,`panimage`,`afront`,`aback`,`panstatus`, `idstatus`, `bank_status` FROM `bank_store` where `jid` = '$mid';";
...
?>
  ...
  <div class="content-wrapper">
    ...
    //|| (date("Y-m-d") >= "2021-11-15")        

$t=time();
$current_time = date("H:i a",$t);
$sunrise = "10:00 am";
$sunset = "05:00 pm";
...
//echo "Due to 21 Day lockdown announced by Hon'ble PM Shri Narendra Modi our Offices are closed till further notice and withdrawal window will open as soon as we are operational. We thank you for co-operation in these difficult times.";
...
if(($day=="1") ||($day=="11")||($day=="21"))
{
    ...
    //           if (($normalized_weekday == "saturday") || ($normalized_weekday == "sunday") || ($date1 < $date2 && $date1 > $date3) || (date("Y-m-d") == "2021-12-25") ) 
    //           {
			 //     echo "Withdrawal is not available on Saturday/Sunday or on a Bank Holiday. Withdrawal can only be done between 10:00 AM and 5:00 PM.";
			 ...
			 // else{
			  ...
			  $sql_ch = "SELECT status FROM withdraw WHERE `jid`='$mid' and status like 'pending';";
			    ...
			    if($status!="pending"){
                			  if(($acctno!="")&&($pancard!="")&&($afront!="")&&($aback!="")&&($panstatus=="Approved")&&($idstatus=="Approved")&&($bank_status=="Approved")){
                			  ?>          
                              <form method="post" action="submit-withdrawl.php" onsubmit="javascript:return validate();" id="myform">
                			  				<?php
                			  						if(@$_GET['errmsg']!=""){				
                			  					?>				
                              				...
                              				<table class="table table-bordered table-striped text-center">
                              				                         ...
                              				                         <tr class="">
                              				                            ...
                              				                            <tr>
                              				                                ...
                              				                                <td>
                              				                                <input type="number" min="100" id="withrsc" name="withrsc"  onKeyUp="check_amt()" autocomplete="off" style=" border:solid 1px #ccc; width:55%; padding:5px; height:30px;" required="required" />
                			  ...
                			  <?php
                			      ...
                			      echo "Please make sure you have completed your KYC / Bank-Details and got it approved.";
                			  }
			    }
			    else{
    ...
    echo "<font color='red'>Withdrawal will be opened on 1st, 11th and 21st of every month.</font><br><br>";
}
			  ?>	
